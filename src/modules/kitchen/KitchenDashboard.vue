  ...
  <div class="min-h-screen bg-gray-100 flex flex-col">
    ...
    <div class="flex flex-1 min-h-0">
      ...
      <div class="flex-1 p-6 overflow-auto">
        <!-- Mutfak Modülü içeriği -->
        <KitchenModule :restaurant-id="restaurant?.id" />
      </div>
    </div>
...
import KitchenModule from './KitchenModule.vue'
...
<style scoped>
/* KitchenDashboard için özel stiller */
</style>