  ...
  <div class="min-h-screen bg-gray-100 flex flex-col">
    ...
    <div class="flex flex-1 min-h-0">
      ...
      <div class="flex-1 p-6 overflow-auto">
        <!-- Rezervasyon Modülü içeriği -->
        <ReservationsModule :restaurant-id="restaurant?.id" />
      </div>
    </div>
...
import ReservationsModule from './ReservationsModule.vue'
...
<style scoped>
/* ReservationsDashboard için özel stiller */
</style> 